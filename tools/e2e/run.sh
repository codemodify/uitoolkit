...
WAYLAND_DISPLAY=uitk-e2e-$N DISPLAY="$(cat "$D/display" 2>/dev/null)" XDG_CONFIG_HOME="${XDG_CONFIG_HOME_OVERRIDE:-$D/cfg}" XDG_DATA_HOME="$D/data" XDG_CACHE_HOME="$D/cache" \
