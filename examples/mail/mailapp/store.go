// Package mailapp is the Thunderbird-chrome Mail client: a pluggable Store
...
//
// It is the sample application shared by ./examples/mail, ./cmd/mailclientd
// and ./cmd/mailclientui, and imports nothing the toolkit does not export.
package mailapp
