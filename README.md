...
not a rectangle), and the three the player demos wear — Minim, Marquee and
Lantern. See [docs/skins.md](docs/skins.md).

![The six skins: Nocturne, Cassette, Deck, Minim, Marquee and Lantern](docs/screenshots/themes/themes-skins.webp)
